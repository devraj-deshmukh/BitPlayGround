...
import "./Profile.css"; // Ensure you have the updated CSS for styling
  ...
  return (
    <div className="profile">
      <div className="profile-header" onClick={toggleDropdown}>
        ...
        <span className="profile-balance">{balance} FakeCoins</span>{" "}
        {/* Wallet balance */}
      </div>
      {isOpen && (
        <div className="profile-dropdown">
          ...
          <p>Wallet Balance: {balance} FakeCoins</p>{" "}
          {/* Showing balance in dropdown */}
          <p>Settings</p>
          <p>Logout</p>
        </div>
      )}
